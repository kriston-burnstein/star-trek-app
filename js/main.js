//Client side creating with Mayan Wolfe streaming
...
async function apiRequest(){
    ...
    try{
        const response = await fetch(`https://my-first-api-to-heroku.herokuapp.com/api/${alienName}`)
...
//https://my-first-api-to-heroku.herokuapp.com/ is my heroku Star Trek API